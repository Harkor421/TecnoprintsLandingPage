...
export const metadata: Metadata = {
  ...
  description: 'Cotiza tu impresión 3D al instante. Sube tu archivo STL y obtén un estimado automático de material. Servicio de impresión 3D en Barranquilla con entrega en 24-48 horas.',
  keywords: [
