          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative">
              ...
              <div className="relative text-center">
                {/* Step number */}
                <div className="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-primary text-black text-xs font-bold flex items-center justify-center">
                  {index + 1}
                </div>

                {/* Icon */}
                <div className="w-16 h-16 rounded-xl bg-surface border border-border flex items-center justify-center mx-auto mb-4 group-hover:border-primary transition-colors">
