...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex items-center overflow-hidden pt-16 md:pt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-surface border border-border mb-4 sm:mb-6">
              <Zap size={14} className="text-primary sm:w-4 sm:h-4" />
              <span className="text-xs sm:text-sm text-muted">Entrega Rápida</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-muted mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6 mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border">
              <div>
                ...
                <div className="text-xs sm:text-sm text-muted">Proyectos</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white">24h</div>
                <div className="text-xs sm:text-sm text-muted">Entrega</div>
              </div>
              <div>
          ...
          {/* 3D Scene */}
          <div className="relative h-[280px] sm:h-[350px] md:h-[450px] lg:h-[550px] order-1 lg:order-2">
            <PrinterScene />
          </div>
        </div>
      </div>
      ...
      <div className="hidden sm:flex absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2">
