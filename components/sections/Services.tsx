    ...
    <section id="services" className="py-16 sm:py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex sm:flex-wrap sm:justify-center gap-2 px-4 sm:px-0">
                {services.map((service) => (
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-2 px-3 sm:px-4 py-2.5 sm:py-2 text-sm font-medium transition-colors whitespace-nowrap touch-manipulation flex-shrink-0',
                      activeService === service.id
                        ? 'bg-primary text-black'
                        : 'bg-surface border border-border text-muted hover:text-white hover:border-primary/70'
                    )}
                  >
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <ScrollFadeIn direction="left" delay={0.2} className="order-2 lg:order-1">
            <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-primary mb-4 sm:mb-6">
            ...
            <ul className="space-y-2 sm:space-y-3">
              {currentService.features.map((feature) => (
                <li key={feature} className="flex items-start sm:items-center gap-3">
                  <div className="w-5 h-5 bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5 sm:mt-0">
          ...
          {/* Placeholder Image */}
          <ScrollFadeIn direction="right" delay={0.3} className="order-1 lg:order-2">
